 ...
 const shuffle = (a) => {
  ...
  const Maze = (Width, Height) => {
    ...
    const map = () => mazeMap;
    const beginCoord = () => startCoord;
    const finishCoord = () => endCoord;
...
const Player = (maze, canvas, _cellsize, onComplete, sprite = null) => {
